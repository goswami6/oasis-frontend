    ...
    <section className="py-20 bg-[#FAF9F6] border-y border-primary-deep/5 overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 md:px-10">
        <div className="text-center mb-24">
          <span className="text-accent-gold font-bold tracking-[0.4em] uppercase text-[11px] mb-6 block">Kiosk Exclusive Menu</span>
          <h2 className="text-4xl md:text-6xl font-serif text-primary-deep italic mb-10 leading-tight">High-Efficiency <span className="text-primary-mist not-italic underline decoration-primary-mist/20 underline-offset-8">Menu.</span></h2>
...
const MediaHub = () => {
  const images = [
    { src: "/assets/oasis_kiosk_main.png", span: "md:col-span-2 md:row-span-2", type: "video" },
    { src: "/assets/kiosk1.png", span: "md:col-span-1 md:row-span-1", type: "image", title: "Industrial Build" },
    { src: "/assets/kiosk2.png", span: "md:col-span-1 md:row-span-1", type: "image", title: "Smart Node" },
    { src: "/assets/kiosk3.png", span: "md:col-span-2 md:row-span-1", type: "image", title: "Autonomous Flow" },
  ];
    ...
    <section className="py-20 bg-primary-deep overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 md:px-10">
        <div className="max-w-3xl mb-24 text-center md:text-left">
          ...
          <h2 className="text-4xl md:text-6xl font-serif text-white italic leading-tight">Unified <br /><span className="text-primary-mist not-italic">Engineering Narrative.</span></h2>
        </div>
              ...
              {item.type === "video" ? (
                <div className="absolute inset-0 cursor-pointer">
                  ...
                  <div className="absolute bottom-10 left-10 p-8 bg-primary-deep/60 backdrop-blur-2xl rounded-3xl border border-white/10 max-w-sm transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-700">
                    <div className="text-primary-mist text-[10px] font-black uppercase tracking-widest mb-1 italic">Play Concept Video</div>
                    <h4 className="text-white font-serif text-xl uppercase tracking-tighter leading-tight">High-Efficiency Managed Flow</h4>
                  </div>
                </div>
              ) : (
    ...
    <div className="max-w-[1400px] mx-auto px-6 md:px-10">
      <div className="grid lg:grid-cols-2 gap-24 items-center">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <span className="text-accent-gold font-bold tracking-[0.3em] uppercase text-[11px] mb-6 block">The Engineering Heart</span>
          <h2 className="text-3xl md:text-5xl font-serif italic mb-10 leading-tight">Mechanical <br />Precision, <span className="text-primary-mist not-italic underline decoration-primary-mist/20 underline-offset-8">Perfect Cup.</span></h2>
          <p className="text-primary-deep/60 text-lg font-light leading-relaxed mb-12">
            The Kiosk integrates industrial-grade precision tools with bespoke coffee mixology sensors. It maintains the exact same quality standard as our flagship Lounge+, but with an optimized footprint.
          </p>
          <div className="grid grid-cols-2 gap-8">
            {[
              { icon: Cpu, title: "AI-Prep", desc: "Digital humidity and grind adjustment." },
              { icon: Settings, title: "Precision Control", desc: "Minimal human maintenance required." },
              { icon: Smartphone, title: "Pulse Cloud", desc: "Real-time volume and inventory analytics." },
              { icon: Layers, title: "Modular", desc: "Elite setup in under 24 hours." }
            ].map((item, i) => (
        ...
        <div className="relative h-[650px] rounded-[64px] border border-primary-deep/5 overflow-hidden group shadow-3xl bg-[#FAF9F6]">
          ...
          <div className="absolute bottom-10 right-10 p-10 bg-white/95 backdrop-blur-xl rounded-[40px] text-primary-deep shadow-2xl border border-primary-deep/5">
            <div className="text-4xl font-serif mb-1 uppercase tracking-tighter text-primary-deep">100%</div>
            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-primary-deep/40">Human-Managed</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-10">
        <div className="grid lg:grid-cols-2 gap-32">
          ...
          <div>
            ...
            <h2 className="text-4xl md:text-6xl font-serif italic mb-12">The ROI <span className="text-primary-mist not-italic">Matrix.</span></h2>
          ...
          <div className="flex flex-col justify-center">
            ...
            <h2 className="text-4xl md:text-5xl font-serif italic mb-12 tracking-tight leading-tight">Where It <span className="text-primary-deep/30 italic">Dominates.</span></h2>
        ...
        {[
          {
            ...
            quote: "The Kiosk was our entry point into the OASIS ecosystem. It&apos;s incredibly low maintenance and the digital tracking is a game changer for remote owners.",
            metrics: "32% MoM Growth"
          },
          {
            name: "Aparna Reddy",
            role: "Airport Spoke Owner",
            quote: "Minimum staff requirement and perfect consistency. We've scaled to 3 kiosks in 6 months because the unit economics just work with our hub team's intervention.",
...
const FAQSection = () => {
  ...
  const faqs = [
    { q: "How is the kiosk restocked?", a: "Restocking is managed by the central Regional Hub (Lounge+). Our AI predicts consumption and triggers a replenishment window for the hub team." },
    { q: "What are the power requirements?", a: "The Kiosk runs on a standard 15A industrial socket with built-in power conditioning and UPS back-up for consistent precision operations." },
    { q: "Is local labor required?", a: "Minimum. A daily 15-minute maintenance check is required, which can be handled by your hub team or local property staff." },
    { q: "How does the OASIS Credit system work?", a: "Users pay via the Oasis App or Card. Credits are cleared in real-time to the owner&apos;s account after platform commission." }
  ];
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
          <div className="p-20 bg-primary-deep rounded-[80px] text-white flex flex-col md:flex-row items-center justify-between gap-16 shadow-3xl relative overflow-hidden">
            ...
            <div className="max-w-2xl relative z-10 text-center md:text-left">
              <h4 className="text-4xl md:text-5xl font-serif mb-8 leading-tight italic">The Perfect Spoke for <br />Your Cluster.</h4>
              ...
              <Link href="/reserve/kiosk" className="inline-block bg-primary-mist text-primary-deep px-16 py-8 rounded-full font-black uppercase tracking-[0.3em] text-xs hover:bg-white hover:scale-105 transition-all shadow-xl">
