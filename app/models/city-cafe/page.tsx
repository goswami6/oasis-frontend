    ...
    <section className="py-20 bg-[#FAF9F6] border-y border-primary-deep/5 overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 md:px-10">
        <div className="text-center mb-20">
          <span className="text-accent-gold font-bold tracking-[0.4em] uppercase text-[11px] mb-6 block">City Cafe Signature Menu</span>
          <h2 className="text-4xl md:text-6xl font-serif text-primary-deep italic mb-10 leading-tight">Full <span className="text-primary-mist not-italic underline decoration-primary-mist/20 underline-offset-8">Signature Suite.</span></h2>
    ...
    <section className="py-20 bg-primary-deep overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 md:px-10">
        <div className="max-w-3xl mb-24 text-center md:text-left">
          ...
          <h2 className="text-4xl md:text-6xl font-serif text-white italic leading-tight">Urban <br /><span className="text-primary-mist not-italic">Lifestyle Center.</span></h2>
        </div>
              ...
              {item.type === "video" ? (
                <div className="absolute inset-0 cursor-pointer">
                  ...
                  <div className="absolute bottom-10 left-10 p-8 bg-primary-deep/60 backdrop-blur-2xl rounded-3xl border border-white/10 max-w-sm transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-700">
                    ...
                    <h4 className="text-white font-serif text-xl uppercase tracking-tighter leading-tight">The Modern Urban Third Space</h4>
                  </div>
                </div>
              ) : (
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-10">
        <div className="grid lg:grid-cols-2 gap-32">
          ...
          <div>
            ...
            <h2 className="text-4xl md:text-6xl font-serif italic mb-12">Urban <br /><span className="text-primary-mist not-italic">Performance.</span></h2>
          ...
          <div className="flex flex-col justify-center">
            ...
            <h2 className="text-4xl md:text-5xl font-serif italic mb-12 tracking-tight leading-tight">Master <br /><span className="text-primary-deep/30 italic">Locality.</span></h2>
...
const FAQSection = () => {
  ...
  const faqs = [
    { q: "What is the optimal space layout?", a: "City Cafes perform best at 500-1000 sqft with a 60/40 split between dine-in area and high-efficiency kitchen nodes." },
    { q: "What menu items are supported?", a: "The City Cafe supports the full OASIS premium menu: signature chai blends, specialty roasts, and an expanded ethno-fusion snack range." },
    { q: "What are the labor requirements?", a: "Typically 4-6 staff members across shifts, including certified OASIS mixologists and node administrators." },
    { q: "How are regional benchmarks set?", a: "We provide data-driven target metrics based on local urban density and competitor proximity to ensure your ROI path is clear." }
  ];
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
          <div className="p-20 bg-primary-deep rounded-[80px] text-white flex flex-col md:flex-row items-center justify-between gap-16 shadow-3xl relative overflow-hidden">
            ...
            <div className="max-w-2xl relative z-10 text-center md:text-left">
              <h4 className="text-4xl md:text-5xl font-serif mb-8 leading-tight italic">The Modern Urban Third Space.</h4>
              ...
              <Link href="/reserve/city-cafe" className="inline-block bg-primary-mist text-primary-deep px-16 py-8 rounded-full font-black uppercase tracking-[0.3em] text-xs hover:bg-white hover:scale-105 transition-all shadow-xl">
